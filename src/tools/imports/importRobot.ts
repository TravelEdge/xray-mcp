...
const BASE_PATH = "/import/execution/robot";

registerTool({
  name: "xray_import_robot",
  description:
    "Import Robot Framework XML test results. Read the Robot Framework output.xml file and pass the full content here. " +
    "Optionally provide testExecInfo for execution-level metadata (summary, description, version). " +
    "Use this tool to push Robot Framework test results into Xray Cloud.",
  accessLevel: "write",
  inputSchema: z.object({
    content: z.string().describe("Robot Framework XML content as a string"),
