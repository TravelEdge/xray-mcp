...
const BASE_PATH = "/import/execution/testng";

registerTool({
  name: "xray_import_testng",
  description:
    "Import TestNG XML test results. Read the TestNG XML output file and pass the full content here. " +
    "Optionally provide testExecInfo for execution-level metadata (summary, description, version). " +
    "Use this tool to push TestNG test results from Java projects into Xray Cloud.",
  accessLevel: "write",
  inputSchema: z.object({
    content: z.string().describe("TestNG XML content as a string"),
