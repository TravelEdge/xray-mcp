...
const BASE_PATH = "/import/execution/junit";

registerTool({
  name: "xray_import_junit",
  description:
    "Import JUnit XML test results. Read the XML file via your Read tool and pass the full content here. " +
    "Optionally provide testExecInfo for execution-level metadata (summary, description, version). " +
    "Use this tool to push JUnit test results from Java/Maven/Gradle builds into Xray Cloud.",
  accessLevel: "write",
  inputSchema: z.object({
    content: z.string().describe("JUnit XML content as a string"),
